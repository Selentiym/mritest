<?php $this->setPageTitle($model->title); ?>
        <div class="span8">
                    ...
                    <div class="page-header">
						<?php 
							echo CHtml::link('Поиск', '/clinics');
							echo CHtml::encode("->");
							echo CHtml::link($model -> name, '/clinics/' . $model -> verbiage);
							echo CHtml::encode("->");
							echo CHtml::link('Файлы и отзывы', '/clinics/' . $model -> verbiage . '/other');
						?>
                        ...
                        <?php if (trim($model->audio) != '') { ?>
                            <?php
                                $this->widget('application.extensions.jouele.Jouele', array(
                                    'file' => Yii::app()->baseUrl. '/files/clinics/' . $model->id . '/'. trim($model->audio),
                    ...
                    <div class="thumbnail" id="comments">
                        ...
                        <?php endif; ?>
                            ...
                            <?php $this->renderPartial('/clinics/_comment_form', array('model'=>$add_comment, 'isNew' => $isNew, 'object_id' => $model->id, 'verbiage' => $model->verbiage)); ?>
                        </div>
