        ...
        <div class="span9">
            ...
            <div class="span2">
                <?php if (trim($data->logo) !=''): ?>
                    <img border="1" align="ABSMIDDLE" src="<?php echo $data -> giveImageFolderRelativeUrl() . $data -> logo;/*Yii::app()->baseUrl.'/images/clinics/' . $data->id . '/' .$data->logo*/ ?>" alt="<?php echo CHtml::encode($data->name);?>">
                <?php endif; ?>
            </div>
            <div class="span10">
                <div class="rating">
                ...
                <br/>
                    <p> <?php echo CHtml::link(CHtml::encode($data->name), Yii::app()->baseUrl.'/clinics/'.$data->verbiage, array('class' => 'Title')); ?> </p>
                ...
                <p class="pull-right">
                    <?php echo CHtml::link('Подробнее...' , Yii::app()->baseUrl.'/clinics/'.$data->verbiage, array('class' => 'btn btn-info')); ?>
                </p>
            </div>
