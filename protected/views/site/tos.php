...
&quot;Times New Roman&quot;;mso-ansi-language:EN">Terms of Use<o:p></o:p></span></h1>
<br>
...
LICENSE</span></strong><span lang="EN" style="mso-ansi-language:EN"> <br>
Any unauthorized use of any Materials or information at this Site may violate
patent, copyright, trademark, and other laws. Any use of this Site or the
Materials shall be considered a limited use license, not a transfer of title,
and is subject to the following restrictions: You may not: (a) modify the
Materials or use them for any commercial purpose, or any public display,
performance, sale or rental; (b) decompile, reverse engineer, disassemble or
...
<p><strong><span lang="EN" style="font-family:Times;mso-ansi-language:EN">4.
...
the e-mail address, passwords and codes (collectively, "ID(s)")
...
Your own risk.<o:p></o:p></span></p>

<p><strong><span lang="EN" style="font-family:Times;mso-ansi-language:EN">7.
REPRESENTATION</span></strong><span lang="EN" style="mso-ansi-language:EN"> <br>
As a user of this Site, You are liable for the accuracy of the information that
You provide to us, including, but not limited to, Your personal and
professional representation as provided in Section 4. You hereby certify that
You are not a paid consultant or have any other financial interests in the
information you provide to this Site, including, but not limited to, the
promotion of "off-label" drug uses, the disclosure of confidential
clinical trial or other proprietary information.<o:p></o:p></span></p>

<p><strong><span lang="EN" style="font-family:Times;mso-ansi-language:EN">8.
PATIENT DATA AND LEGAL COMPLIANCE</span></strong><span lang="EN" style="mso-ansi-language:EN"> <br>
The Site is not intended for the transmission, storing, review or receipt of
confidential patient information ("Patient Information"). However, if
you upload such Patient Information to the Site, the following terms apply.
...
on their behalf, to make use of certain Materials or to transmit certain
information to third parties. You represent and warrant that You will, at all
times during the term of this Agreement and thereafter, comply with all laws
directly or indirectly applicable to You that may now or hereafter govern the
gathering, use, transmission, processing, receipt, reporting, disclosure,
maintenance, and storage of the Patient Information, and use Your best efforts
to cause all persons or entities under Your direction or control to comply with
such laws. You are, at all times during the term of this Agreement and
thereafter, solely responsible for obtaining and maintaining all patient
...
applicable, in connection with the operation or use such Materials, and are
acting on Your behalf in transmitting Patient Information.<o:p></o:p></span></p>

<p><span lang="EN" style="mso-ansi-language:EN">WE CANNOT AND DO NOT ASSUME ANY
...
GENERAL DISCLAIMERS</span></strong><span lang="EN" style="mso-ansi-language:EN"> <br>
THE MATERIALS AND THE SITE IS PROVIDED "AS IS" WITHOUT ANY EXPRESS OR
...
OF PROFITS, BUSINESS INTERRUPTION, LOSS OF INFORMATION AND LOSS OF BUSINESS
OPPORTUNITIES) ARISING OUT OF OR RELATING TO (1) THE USE OF OR INABILITY TO USE
THE MATERIALS, OR (2) RELIANCE ON THE CONTENT AND MATERIALS OR THE SITE, OR (3)
ERRORS, INACCURACIES, OMISSIONS, DEFECTS, UNTIMELINESS, SECURITY BREACHES, OR
...
YOU ARE RESPONSIBLE FOR TAKING ALL PRECAUTIONS YOU BELIEVE NECESSARY OR
...
unlawful use of the Site by any other person using Your ID.<o:p></o:p></span></p>

<p><strong><span lang="EN" style="font-family:Times;mso-ansi-language:EN">12.
USER SUBMISSIONS</span></strong><span lang="EN" style="mso-ansi-language:EN"> <o:p></o:p></span></p>

<p><strong><span lang="EN" style="font-family:Times;mso-ansi-language:EN">General:</span></strong><span lang="EN" style="mso-ansi-language:EN"> <br>
...
any breach or from defending against any allegations of a breach determined to
be unfounded.<o:p></o:p></span></p>
...
Any failure to enforce any term or provision of this Agreement shall not be
deemed a waiver of that or any other breach of that or any other term or
provision of this Agreement. In addition, any failure to enforce any term or
provision of this Agreement shall not constitute a waiver of a future breach of
that or any other term or provision of this Agreement.<o:p></o:p></span></p>
...
<p><strong><span lang="EN" style="font-family:Times;mso-ansi-language:EN">22.
HEADINGS</span></strong><span lang="EN" style="mso-ansi-language:EN"> <br>
The headings of articles and sections contained in this Agreement are for
reference purposes only and shall not affect in any way the meaning or
interpretation of this Agreement.<o:p></o:p></span></p>

<p><strong><span lang="EN" style="font-family:Times;mso-ansi-language:EN">23.
INVALIDITY</span></strong><span lang="EN" style="mso-ansi-language:EN"> <br>
If any provision of this Agreement shall be held, be deemed or shall in fact
be, invalid, inoperative or unenforceable as applied to any particular case or
circumstance because of the conflicts of any provision with any law,
regulation, ordinance or for any other reason, the provision or provisions in
question shall not be invalid, inoperative or unenforceable in any other case
or circumstance, nor shall any other provision or provisions herein contained
thereby be or become invalid, inoperative or unenforceable and such provision
shall be reformed so that it would be valid, operative and enforceable to the
maximum extent permitted in such circumstances.<o:p></o:p></span></p>
...
mso-bidi-font-family:&quot;Times New Roman&quot;;mso-ansi-language:EN"><span style="mso-spacerun:yes"> </span><o:p></o:p></span></p>
