...
class AdminController extends Controller
{
	...
	{
		$model=new RightText('search');
		//print_r($_FILES);
		if(isset($_POST['RightText']))
		{
			$model->attributes=$_POST['RightText'];
		...
		$this->render('//admin/RightTexts/_form',array('model'=>$model));
	}
	public function actionRightTextsUpdate($id)
	{
		$model=RightText::model() -> findByPk($id);
	...
	/*
	* Export clinics in a csv file.
	* $fields array specifies which fields are to be exported. 
	...
	*/
	...
	{
		clinics::model() -> ExportCsv($this -> fields);
	}
